...
run_id = "d534df0df9f348d89b74fc7abbda7107"

# Replace with the path to the logged model within the run
model_path = "mlflow-artifacts:/0/d534df0df9f348d89b74fc7abbda7107/artifacts/best_model"

# Construct the model URI
model_uri = f"runs:/{run_id}/{model_path}"

# Register the model in the model registry
model_name = "DIABETES MODEL RF"
